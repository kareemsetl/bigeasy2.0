    ...
    <>
      ...
      <main className="flex justify-center h-full mt-20">
        <div className="bg-slate-200 w-full h-full border-slate-400 border-x" style={{
          ...
          <h3>UNAPOLOGETICALLY PROGRESSIVE</h3>
          <div>From the beginning, we have proudly stated that we are a progressive publication. We see the world through a progressive lens, and we believe in such values as love and inclusiveness. We only state facts, and we will never mislead our readers. But at Big Easy Magazine, we are unapologetically progressive.</div>
          <h3>MISSION STATEMENT</h3>
          <div>For a city under threat from water, for a city that stays up all night, in a world in need of different perspectives. With insight and introspection, we strive to deliver thorough and thoughtful coverage with a progressive voice about the issues that truly matter to the New Orleans community.</div>
          <h3>CORE VALUES</h3>
          ...
          <h3 className="center">OUR TEAM</h3>
            <figure className="wp-block-media-text__media"><img className="aligncenter wp-image-73596" src="https://www.bigeasymagazine.com/wp-content/uploads/2018/06/SCOTT-THE-CHIEF-EXECUTIVE-OF-BIGEASY-MAGAZINE-1-1024x683.jpg" alt="Scott Ploof | Online Home for Progressive New Orleans"/></figure>
            ...
            <img className="aligncenter wp-image-74768" src="https://www.bigeasymagazine.com/wp-content/uploads/2018/07/Nolan-8-2009.jpg" alt="Nolan Storey | Online Home for Progressive New Orleans"  />
        ...
        <div className="wp-block-media-text alignwide is-stacked-on-mobile">
          <figure className="wp-block-media-text__media"><img className="aligncenter wp-image-97600" src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/IMG_3563-1024x1024.jpg" alt="Michael Raso | Online Home for Progressive New Orleans" /></figure>
          <div className="wp-block-media-text__content">
            <p>&nbsp;</p>
            ...
            <p><em>Born a Midwesterner but raised in a small town in Central Louisiana, Michael Raso earned a Bachelor’s in communication from went on to go to school at UL at Lafayette. He currently covers breaking news, politics and creates satire for Big Easy Magazine. He’s currently shopping his latest book, tentatively titled “The Black House” For more information, go to <a href="http://michaeldraso.com/">michaeldraso.com</a>.</em></p>
          </div>
        </div>
        ...
        <div className="wp-block-media-text alignwide is-stacked-on-mobile">
          <figure className="wp-block-media-text__media"><img className="aligncenter wp-image-97604" src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/image1-1-1-1024x1024.png" alt="Candice Battiste | Online Home for Progressive New Orleans"/></figure>
          <div className="wp-block-media-text__content">
            <p>&nbsp;</p>
            ...
            <p><em>Battiste's roots extend from Shreveport to New Orleans. She is currently the North Louisiana organizer for Power Coalition for Equity and Justice. She is an alum of Louisiana State University and earned her juris doctorate from Southern University Law Center. Candice serves on a number of statewide and local boards centered civil rights, economic empowerment, and racial equity. When Candice is not working to affect positive change, she is traveling or can be found at one of Louisiana’s many food and music festivals.</em></p>
          </div>
        </div>
        ...
        <div className="wp-block-media-text alignwide is-stacked-on-mobile">
          <figure className="wp-block-media-text__media"><img className="aligncenter wp-image-97605" src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/Raegan-Carter-1024x1024.jpg" alt="Raegan A Carter | Online Home for Progressive New Orleans"  /></figure>
          <div className="wp-block-media-text__content">
            <p>&nbsp;</p>
        ...
        <div className="wp-block-media-text alignwide is-stacked-on-mobile">
          <figure className="wp-block-media-text__media"><img className="aligncenter wp-image-97606" src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/IMG_20201024_142923_722-1024x1024.jpg" alt="Asad El Malik | Online Home for Progressive New Orleans" /></figure>
          <div className="wp-block-media-text__content">
            <p>&nbsp;</p>
        ...
        <p><a href="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/casting-3.jpg"><img className="aligncenter wp-image-97907" src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/casting-3.jpg" alt="Helen Lewis | Online Home for Progressive New Orleans" /></a></p>


        <div className="wp-block-media-text alignwide is-stacked-on-mobile">
          <figure className="wp-block-media-text__media"></figure>
          <div className="wp-block-media-text__content">
            <p>&nbsp;</p>
            <p><a href="https://www.bigeasymagazine.com/tag/helen-lewis/"><strong>Helen Lewis- Contributing Writer</strong></a></p>
        ...
        <div className="wp-block-media-text alignwide is-stacked-on-mobile">
          <figure className="wp-block-media-text__media"><img className="wp-image-97615 aligncenter" src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/Giselle-1024x1024.png" alt="Giselle P. Dussel | Online Home for Progressive New Orleans" /></figure>
          <div className="wp-block-media-text__content">
            <p>&nbsp;</p>
            ...
            <hr />
            <p><img className="aligncenter wp-image-106418" src="https://www.bigeasymagazine.com/wp-content/uploads/2021/10/Richard_Windmann.jpeg" alt="Richard G. Windmann | Online Home for Progressive New Orleans" /></p>
        ...
        <div className="wp-block-media-text alignwide is-stacked-on-mobile"><hr />
          <p><a href="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/evangelinebarberploofpic.jpg"><img className="aligncenter wp-image-97909" src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/evangelinebarberploofpic.jpg" alt="Evangeline Barber Ploof | Online Home for Progressive New Orleans"  /></a></p>
        </div>
        <div className="wp-block-media-text alignwide is-stacked-on-mobile">Evangeline Barber Ploof - Chief Operations Officer </div>
        <div> </div>
        <div className="wp-block-media-text alignwide is-stacked-on-mobile"><em>Evangeline Barber Ploof has a B.A. in Elementary Education. For seven years, she taught special education for children in elementary school. In 2019, she began work as Chief Operations Officer for Big Easy Magazine. She is married to Big Easy Magazine Founder and Publisher Scott Ploof. She is a native New Orleanian. When she is not working, she enjoys cooking and caring for her three dogs.</em></div>
        </div>
      </main>
    </>
  );
