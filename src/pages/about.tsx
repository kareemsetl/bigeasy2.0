        ...
        <div className="bg-slate-200 w-full h-full border-slate-400 border-x p-5" style={{
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="team-member grid grid-cols-2 gap-4 items-center">
              <Image src="https://www.bigeasymagazine.com/wp-content/uploads/2018/06/SCOTT-THE-CHIEF-EXECUTIVE-OF-BIGEASY-MAGAZINE-1-1024x683.jpg" alt="Scott Ploof" className="max-w-[300px] max-h-[300px] rounded border shadow-lg" />
              <div>
                <p><strong><Link href="/author/Scott-Ploof" className="text-blue-500 hover:text-blue-700">Scott Ploof - Publisher</Link></strong></p>
            ...
            <div className="team-member grid grid-cols-2 gap-4 items-center">
              <Image src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/evangelinebarberploofpic.jpg" alt="Evangeline Barber Ploof" className="max-w-[300px] max-h-[300px] rounded border shadow-lg" />
              <div>
                <p><strong><Link href="/author/Evangeline-Barber-Ploof/" className="text-blue-500 hover:text-blue-700">Evangeline Barber Ploof - Chief Operations Officer</Link></strong></p>
            ...
            <div className="team-member grid grid-cols-2 gap-4 items-center">
              <Image src="https://www.bigeasymagazine.com/wp-content/uploads/2018/07/Nolan-8-2009.jpg" alt="Nolan Storey" className="max-w-[300px] max-h-[300px] rounded border shadow-lg" />
              <div>
                <p><strong><Link href="/author/Nolan-Storey/" className="text-blue-500 hover:text-blue-700">Nolan Storey - Founding Editorial Board Member / Staff Writer</Link></strong></p>
            ...
            <div className="team-member grid grid-cols-2 gap-4 items-center">
              <Image src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/IMG_3563-1024x1024.jpg" alt="Michael Raso" className="max-w-[300px] max-h-[300px] rounded border shadow-lg" />
              <div>
                <p><strong><Link href="/author/Michael-Raso/" className="text-blue-500 hover:text-blue-700">Michael Raso - Contributing Writer</Link></strong></p>
                <p><em><em>Born a Midwesterner but raised in a small town in Central Louisiana, Michael Raso earned a Bachelor’s in communication from went on to go to school at UL at Lafayette. He currently covers breaking news, politics and creates satire for Big Easy Magazine. He’s currently shopping his latest book, tentatively titled “The Black House” For more information, go to <Link href="http://michaeldraso.com/">michaeldraso.com</Link>.</em></em></p>
              </div>
            </div>

            <div className="team-member grid grid-cols-2 gap-4 items-center">
              <Image src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/image1-1-1-1024x1024.png" alt="Candice Battiste" className="max-w-[300px] max-h-[300px] rounded border shadow-lg" />
              <div>
                <p><strong><Link href="/author/Candice-Battiste/" className="text-blue-500 hover:text-blue-700">Candice Battiste - Contributing Writer</Link></strong></p>
            ...
            <div className="team-member grid grid-cols-2 gap-4 items-center">
              <Image src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/Raegan-Carter-1024x1024.jpg" alt="Raegan A Carter" className="max-w-[300px] max-h-[300px] rounded border shadow-lg" />
              <div>
            ...
            <div className="team-member grid grid-cols-2 gap-4 items-center">
              <Image src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/IMG_20201024_142923_722-1024x1024.jpg" alt="Asad El Malik" className="max-w-[300px] max-h-[300px] rounded border shadow-lg" />
              <div>
                <p><strong><Link href="/author/Asad-El-Malik/" className="text-blue-500 hover:text-blue-700">Asad El Malik- Contributing Writer</Link></strong></p>
            ...
            <div className="team-member grid grid-cols-2 gap-4 items-center">
              <Image src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/casting-3.jpg" alt="Helen Lewis" className="max-w-[300px] max-h-[300px] rounded border shadow-lg" />
              <div>
                <p><strong><Link href="/author/Helen-Lewis/" className="text-blue-500 hover:text-blue-700">Helen Lewis- Contributing Writer</Link></strong></p>
            ...
            <div className="team-member grid grid-cols-2 gap-4 items-center">
              <Image src="https://www.bigeasymagazine.com/wp-content/uploads/2020/12/Giselle-1024x1024.png" alt="Giselle Dussel" className="max-w-[300px] max-h-[300px] rounded border shadow-lg" />
              <div>
                <p><strong><Link href="/author/Giselle-Dussel/" className="text-blue-500 hover:text-blue-700">Giselle Dussel- Contributing writer</Link></strong></p>
            ...
            <div className="team-member grid grid-cols-2 gap-4 items-center">
              <Image src="https://www.bigeasymagazine.com/wp-content/uploads/2021/10/Richard_Windmann.jpeg" alt="Richard G. Windmann" className="max-w-[300px] max-h-[300px] rounded border shadow-lg" />
              <div>
                <p><strong><Link href="/author/Richard-Windmann" className="text-blue-500 hover:text-blue-700">Richard G. Windmann - Contributing writer</Link></strong></p>
                <p><em><i>Richard G. Windmann is a native son of New Orleans, and describes himself as "Proud Baratarian and a Helluva Nice Guy." He is a Computer Scientist, and works for IBM. He is also the co-founder and President of <Link href="http://www.scsaorg.org" target="_blank" rel="noopener noreferrer">Survivors of Childhood Sex Abuse (SCSA)</Link>, a 501(c)(3) advocacy organization that provides free support to victims and survivors of childhood sex abuse and their families. He is a devout Catholic who is hell-bent on saving his church. He is also a loving husband, father and grandfather.</i></em></p>
              </div>
            </div>
          </div>
        </div>
